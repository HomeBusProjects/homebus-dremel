...
require_relative 'lib/homebus-dremel/version'

Gem::Specification.new do |spec|
  spec.name = 'homebus-dremel'
  spec.version = HomebusDremel::VERSION
  ...
  spec.homepage = 'https://github.com/HomeBusProjects/homebus-dremel'
  spec.license = 'MIT'
  spec.required_ruby_version = '>= 2.7.4'

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/HomeBusProjects/homebus-dremel'
